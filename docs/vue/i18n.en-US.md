...
ui-vue-antd provides a Vue Component [LocaleProvider](/ant-design/components/locale-provider) for configuring ui-vue-antd locale text globally.
...
<script>
import zhCN from 'ui-vue-antd/lib/locale-provider/zh_CN';
export default {
  data() {
    return {
      locale: zhCN,
